...
<body>
    <div class="center">
        ...
        <form action="<?php echo e(route('signin')); ?>" method="post">
            ...
            <p><br>Don't have an account yet? <a href="<?php echo e(route('register')); ?>">Register</a></p><br><br>
        </form>
    </div>
</body>
...
<?php /**PATH C:\Users\Aymmon\Downloads\Compressed\jnjphotography-main\resources\views/auth/signin.blade.php ENDPATH**/ ?>