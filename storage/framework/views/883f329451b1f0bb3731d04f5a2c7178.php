...
<body>
    <div class="center">
        ...
        <form action="<?php echo e(route('register')); ?>" method="post">
            ...
            <input type="text" id="fullname" name="fullname" value="<?php echo e(old('fullname')); ?>" required><br><br>
        
            <label for="email">Email:</label><br>
            <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required><br><br>
        
            <label for="username">Username:</label><br>
            <input type="text" id="username" name="username" value="<?php echo e(old('username')); ?>" required><br><br>
        ...
        <p>Have an account? <a href="<?php echo e(route('signin')); ?>">Login!</a></p> <br> <br>
    </div>    
</body>
...
<?php /**PATH C:\Users\Aymmon\Downloads\Compressed\jnjphotography-main\resources\views\auth\register.blade.php ENDPATH**/ ?>